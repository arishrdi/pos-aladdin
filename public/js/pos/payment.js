...
class PaymentManager {
    ...
    attachMemberSearchListeners() {
        ...
        // Debounced search - Optimized: reduced delay from 300ms to 150ms
        const debouncedSearch = debounce(async (query) => {
            ...
            try {
                ...
                memberDropdown.innerHTML = `
                    <div class="p-3 text-center">
                        <div class="inline-flex items-center text-gray-600">
                            ...
                            <span class="text-sm">Mencari member...</span>
                        </div>
                    </div>
                `;
                ...
                memberDropdown.innerHTML = '<div class="p-3 text-red-500 text-sm">Terjadi kesalahan saat mencari member</div>';
                memberDropdown.classList.remove('hidden');
            }
        }, 150);
