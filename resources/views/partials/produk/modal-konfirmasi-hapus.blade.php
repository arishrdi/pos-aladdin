    ...
    <div class="bg-white rounded-lg shadow-lg w-full max-w-md overflow-hidden">
        ...
        <div class="p-4">
            <div class="flex items-start gap-3">
                ...
                <div>
                    <h4 class="text-base font-medium text-gray-800 mb-1">Hapus Produk</h4>
                    <p class="text-sm text-gray-600">Yakin ingin menghapus produk "<span id="hapusNamaProduk" class="font-medium">Produk</span>"? Data yang dihapus tidak dapat dikembalikan.</p>
                </div>
            </div>
        </div>
